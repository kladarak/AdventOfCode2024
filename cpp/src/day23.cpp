...
namespace d23
{
	...
	static uint64_t partOne([[maybe_unused]] const Data23& data)
	{
		return 0;
	}

	static uint64_t partTwo([[maybe_unused]] const Data23& data)
	{
		return 0;
	}
...
void day23()
{
	d23::processPrintAndAssert("../data/23/test.txt", 0ull, 0ull);
	d23::processPrintAndAssert("../data/23/real.txt", 0ull, 0ull);
}
