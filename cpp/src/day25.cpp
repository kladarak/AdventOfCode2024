...
namespace d25
{
	...
	static uint64_t partOne([[maybe_unused]] const Data25& data)
	{
		return 0;
	}
...
void day25()
{
	d25::processPrintAndAssert("../data/25/test.txt", 0ull, 0ull);
	d25::processPrintAndAssert("../data/25/real.txt", 0ull, 0ull);
}
