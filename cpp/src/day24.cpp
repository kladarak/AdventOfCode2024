...
namespace d24
{
	...
	static uint64_t partOne([[maybe_unused]] const Data24& data)
	{
		return 0;
	}

	static uint64_t partTwo([[maybe_unused]] const Data24& data)
	{
		return 0;
	}
...
void day24()
{
	d24::processPrintAndAssert("../data/24/test.txt", 0ull, 0ull);
	d24::processPrintAndAssert("../data/24/real.txt", 0ull, 0ull);
}
