...
namespace d21
{
	...
	static uint64_t partOne([[maybe_unused]] const Data21& data)
	{
		return 0;
	}

	static uint64_t partTwo([[maybe_unused]] const Data21& data)
	{
		return 0;
	}
...
void day21()
{
	d21::processPrintAndAssert("../data/21/test.txt", 0ull, 0ull);
	d21::processPrintAndAssert("../data/21/real.txt", 0ull, 0ull);
}
